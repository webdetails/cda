...
public class StaticDataFactorySample
{
  ...
  {
    final TypedTableModel model = new TypedTableModel(new String[]{"ID", "TEXT"}, new Class[]{Long.class, String.class}, 0);
  ...
  public TableModel createSubQuery(Long parameter)
  {
    ...
    else
    {
      ...
      model.addRow(new Object[]{parameter, new Long(1), "Subreports can use parameters to control what data is returned."});
      return model;
    }
